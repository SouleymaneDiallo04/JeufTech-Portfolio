...
const experiences = [
  ...
  org: 'Smart Digital Systems (SDS)',
  desc: "Conception de systèmes intelligents de bout en bout, du capteur physique au modèle validé, au service de l'agriculture de précision, de la surveillance environnementale et du contrôle qualité agroalimentaire. Un stage à forte dimension recherche appliquée, combinant instrumentation, IA embarquée sur microcontrôleur et science des données à la rigueur scientifique.",
  missions: [
    ...
    "Développement de firmware embarqué sur microcontrôleur ESP32 / Heltec (C++, framework Arduino, PlatformIO) : acquisition de capteurs multi-gaz en liaison série UART, décodage de trames binaires et contrôle d'intégrité (somme de contrôle).",
    "Contrôle qualité agroalimentaire : chaîne d'acquisition et d'analyse d'un nez électronique (capteur Bosch BME688 à balayage thermique et module Grove) pour la mesure de l'acidité d'huiles d'olive, avec traitement du signal, régression PLS et validation croisée Q², avec analyse causale des résultats.",
  ...
  achievements: [
    ...
    "Résultat de recherche : démonstration, par une méthodologie expérimentale rigoureuse (plan anti-dérive, PLS, validation croisée Q²), des limites physico-chimiques d'une approche capteur, avec analyse de cause plutôt qu'un simple constat ; travaux à visée de valorisation scientifique.",
  ],
  },
  {
  type: 'Stage',
