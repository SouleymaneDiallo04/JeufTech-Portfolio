...
const experiences = [
  ...
  missions: [
    ...
    "Une équipe de 6 agents IA aux profils complémentaires (créatif, technique, critique, pragmatique…) qui imaginent, débattent et affinent les idées, comme un vrai bureau d'études.",
    "S'appuyer sur des méthodes de conception reconnues (Design Thinking, TRIZ, Six Sigma) pour structurer la réflexion et fiabiliser les choix.",
    "Générer un véritable modèle 3D fabricable et aller jusqu'à simuler sa résistance mécanique et son comportement face à l'air, pas seulement une image.",
    "Un copilote en langage naturel : on demande une modification (« ajoute un arrondi de 3 mm »), et le modèle 3D se met à jour tout seul.",
    "Produire des livrables prêts à l'emploi : cahier des charges complet (fonctions, critères, normes, coût, liste des pièces) exporté en PDF professionnel, et travail d'équipe en temps réel où chaque proposition est votée, validée et sourcée.",
  ],
  techs: ['Systèmes multi-agents', 'LLM', 'RAG', 'Design Thinking', 'TRIZ', 'Six Sigma', 'CAO / FreeCAD', 'PostgreSQL', 'Docker'],
  achievements: [
    "La plateforme accomplit en une seule session le travail qui mobilise d'ordinaire une équipe pluridisciplinaire pendant des semaines.",
    "Six agents IA aux profils complémentaires brainstorment, débattent et se critiquent pour faire émerger puis trancher les meilleures idées.",
    "Chaque idée est menée jusqu'à un modèle 3D réellement fabricable, dont la résistance mécanique et l'aérodynamique sont vérifiées par le calcul.",
    "La méthode TRIZ résout les contradictions techniques d'un produit, comme le rendre plus léger sans le fragiliser, à partir de principes inventifs éprouvés.",
    "Le cahier des charges normé, la nomenclature chiffrée avec prix fournisseurs réels et le plan de validation sont générés automatiquement, prêts à présenter à un décideur.",
    "Chaque proposition de l'IA s'appuie sur des documents réels et n'est retenue qu'après validation de l'équipe.",
  ],
  },
  {
  type: 'Stage',
  ...
  <div className="tab-pane active">
    ...
    <div style={{display:'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 12 : 16, maxWidth:940, margin:'0 auto'}}>
      {[
        ...
        { icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>, label:'Adresse', value:'Rabat, Maroc' },
