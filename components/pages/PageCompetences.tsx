...
const experiences = [
  ...
  desc: "Conception de systèmes intelligents de bout en bout, du capteur physique au modèle validé, au service de l'agriculture de précision et du contrôle qualité agroalimentaire. Un stage à forte dimension recherche appliquée, combinant instrumentation, IA embarquée sur microcontrôleur et science des données à la rigueur scientifique.",
  missions: [
